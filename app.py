...
st.markdown(
    ...
    .wine-card { background-color: #FFFFFF; color: #1A1A1A; border-radius: 14px; padding: 16px; margin-bottom: 12px; border: 2px solid #FF1493; box-shadow: 0px 4px 12px rgba(255, 20, 147, 0.15); }
    .wine-title { color: #FF1493; font-size: 1.1rem; font-weight: 700; margin-bottom: 4px; }
    .badge-pallet-grande { background-color: #FF1493; color: #FFFFFF; padding: 6px 14px; border-radius: 8px; font-weight: 700; font-size: 1rem; display: inline-block; }
...
def componente_leitor_barcode(chave_sessao):
    ...
    <div style="text-align: center;">
        ...
        <p id="resultado_{chave_sessao}" style="font-weight: bold; color: #FF1493; margin-top: 8px;"></p>
    </div>
